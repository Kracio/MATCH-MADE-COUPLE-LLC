...
export function SectionShell({ id, eyebrow, title, children, className = "" }: SectionShellProps) {
  return (
    <section id={id} className={`px-4 py-24 sm:px-6 lg:px-8 lg:py-32 ${className}`}>
      <div className="mx-auto max-w-7xl">
        <div data-reveal className="mb-12 max-w-3xl lg:mb-16">
          ...
          <h2 className="font-display text-4xl font-semibold leading-[0.95] tracking-[-0.035em] text-lava sm:text-5xl lg:text-7xl">
            {title}
          </h2>
        </div>
        {children}
