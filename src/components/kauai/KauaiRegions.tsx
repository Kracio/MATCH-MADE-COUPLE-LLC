      ...
      {regions.map((region, idx) => (
        <section key={region.id} id={region.id} className="border-t border-lava/10">
          <div className="relative flex min-h-[480px] h-[60vh] items-end overflow-hidden px-6 py-16 sm:px-12 lg:px-20">
            ...
            <div data-reveal-stagger className="relative z-10 max-w-2xl">
              <span data-reveal-child className="mb-4 block text-sm tracking-[0.3em] text-hibiscus uppercase font-medium">
                {region.tag}
              </span>
              <h2 data-reveal-child className="mb-2 font-display text-[clamp(2.5rem,6vw,4.5rem)] font-light leading-none text-shell">
              ...
              <p data-reveal-child className="mt-4 max-w-[560px] font-display text-xl font-light italic leading-[1.6] text-shell/80">
                {region.description}
              </p>
            </div>
          </div>
          ...
          <div className="bg-shell px-6 py-12 sm:px-12 sm:py-16 lg:px-20 lg:py-20">
            <div data-reveal-stagger className="mx-auto grid max-w-7xl gap-16 md:grid-cols-2 lg:grid-cols-3">
              {region.sections.map((section, sIdx) => (
                <div key={sIdx} data-reveal-child>
            ...
            {region.bonus && (
              <div className="mx-auto mt-16 max-w-7xl">
                <div data-reveal="scale" className="rounded-3xl bg-sand/30 p-10 outline outline-1 outline-lava/5">
